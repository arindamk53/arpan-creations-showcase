...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive, compassionate family healthcare in Richmond, TX. Dr. Batool Asar offers in-person and telemedicine appointments. Board-certified, FAAFP Fellow.',
};
  ...
  const items = [
    {
      ...
      subtitle: 'HIPAA-compliant care you can trust.',
    },
    {
      icon: CalendarCheck,
      title: 'Flexible rescheduling — no penalties.',
      subtitle: 'Life happens. We understand.',
    },
    {
      icon: Phone,
      title: 'Call us: (346) 244-2106',
